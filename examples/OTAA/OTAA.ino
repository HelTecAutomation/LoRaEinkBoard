...
/* OTAA para*/
uint8_t devEui[] = { 0x22, 0x32, 0x33, 0x00, 0x00, 0x00, 0x00, 0x01 };
...
static void prepareTxFrame( uint8_t port )
{
    if(aaa==0)
    {
      appDataSize = 200;//AppDataSize max value is 64
      aaa++;
    }
    else
    appDataSize=4;
...
//  while (!Serial);+
  ...
  Mcu.init(license);
  SX126xWriteRegister(0x0740,0xAB);
  Serial.println(SX126xReadRegister(0x0740));
