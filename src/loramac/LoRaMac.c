...
static void wota_CadDone( bool channelActivityDetected )
{
    ...
    else
    {
        Radio.Sleep( );
        wota_CadStarted = false;
		TimerSetValue(&wota_CadTimer,wota_cycle_time);
		TimerStart(&wota_CadTimer);
    }
